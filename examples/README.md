...
This is an example of parallel-safe but asymmetric library.
See
[here](https://github.com/ocaml-multicore/saturn?tab=readme-ov-file#lock-free-multiple-producers-single-consumer-queue)
for more details.
